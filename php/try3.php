...
<body>
	...
	<center>
		...
		<form action="try3.php">
			<input type="text" name="keyword" id="myInput" onkeyup="myFunction()" placeholder="Search Student Roll No here" title="Type in a name" style="border-color:black;" required>
	</center>
	...
	<br>
	<center><input type="submit" class="btn" value="Back" onclick="goBack()"></center>
	...
	<div class="form-popup" id="myForm">
		<form action="update_student.php" class="form-container">
			...
			<input type="text" placeholder="Enter Issue Date" name="Issue_Date" value="<?php $d = strtotime("today");
																						echo date("Y-m-d ", $d);  ?>">

			<label for="Return_Date"><b>Return Date</b></label>
			<input type="text" placeholder="Enter Return Date" name="Return_Date" value="<?php $d = strtotime("+7 days");
																							echo date("Y-m-d ", $d);  ?>">
